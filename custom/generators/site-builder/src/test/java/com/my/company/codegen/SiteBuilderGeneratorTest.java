 ...
 * 1) Set a break point in SiteBuilderGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class SiteBuilderGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("site-builder") // use this codegen library
              ...
              .setOutputDir("out/site-builder"); // output directory
